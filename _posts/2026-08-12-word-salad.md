...
Up until this point you have been walking along a path that someone else has made, but this is only one of many paths. 

Before you reach your desired location, step off the path. Go through the bushes, jump over a fence, and observe the steep incline beside you. Visualise a new route, and evaluate the risk based on the available information; this could include your footwear, cues for any unstable rocks, or a branch that will easily snap. 
...
![Guide](/assets/images/wide-tree.jpeg)
